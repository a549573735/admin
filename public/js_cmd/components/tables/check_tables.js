        ...
        template:'<table class="table  table-hover table-borderless o-m-t">\
                      ...
                      <tbody class="v-tabs-check">\
                        <tr v-for="item in datalist.content.content">\
                            <td  class="text-center"><label v-if="datalist.overfull" class="css-input css-checkbox css-checkbox-primary">\
                            ...
                            <td    class="text-center"><a v-if="datalist.overfull_btn"  :href="datalist.href+item.id"   class="btn  btn-primary v-btn-w"> 详情</a></td>\
                        </tr>\
                      </tbody>\
                  </table>', 
